...
from segmentation_heads.mask2former.utils import Mask2FormerPixelLevelModuleCustom, Mask2FormerModel_CustomForward
...
class CARL_Mask2Former(CARLModel):
    ...
    def __init__(
        ...
        feature_channels = [self.spatial_encoder.embed_dim] * 4
        ...
        self.mask2former.model.pixel_level_module = Mask2FormerPixelLevelModuleCustom(mask2former_config, feature_channels=feature_channels)
        self.mask2former.model.forward = types.MethodType(Mask2FormerModel_CustomForward, self.mask2former.model)
    ...
    def forward(
        ...
        out: Mask2FormerForUniversalSegmentationOutput = self.mask2former(
            pixel_values=multi_scale_features,
